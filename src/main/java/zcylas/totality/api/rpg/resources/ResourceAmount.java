 ...
 * (canonical §16.6) and, in the canonical design, the future {@code PlayerResourceService}'s
 ...
 * example. No transaction, live-state validation, or mutation logic belongs here — that is the
 * future {@code PlayerResourceService}'s responsibility, not implemented by this Phase 1 patch.
 */
